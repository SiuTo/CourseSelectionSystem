			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					...
					<?php
						...
						$result=mysql_query("SELECT SID, PASSWORD, SNAME, SBIRTH, SSEX, SYEAR, DNAME FROM STUDENT, DEPARTMENT WHERE STUDENT.SID='$_SESSION[userId]' AND STUDENT.DID=DEPARTMENT.DID");
